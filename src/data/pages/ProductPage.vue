<template>
  ...
  <main class="content container" v-else-if="!productData">Не удолось загрузить товар</main>
      ...
      <div class="item__info">
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            <b class="item__price"> {{ product.price | numberFormat }} p </b>
            ...
            <div class="item__row">
              <div class="form__counter">
                ...
                <input class="count" type="text" v-model.number="productAmount" />
...
export default {
  ...
  methods: {
    ...
    delit() {
      const namber = document.querySelectorAll(".count")[0];
